...
class Vector3 {
    ...
    static dot(other1, other2) {
        // Insert your code here.
        var d = (other1.elements[0] * other2.elements[0]) +
    ...
    static cross(other1, other2) {
        ...
        v3.elements[1] = other1.elements[2] * other2.elements[0] -
    ...
    magnitude() {
        // Insert your code here.
        var xSq = Math.pow(this.elements[0], 2);
        var ySq = Math.pow(this.elements[1], 2);
        var zSq = Math.pow(this.elements[2], 2);
